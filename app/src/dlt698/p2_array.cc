...
//{{{ misc
//static const P2ArrayPcut *ToDerive(const Pcut *part)
//{
//	return (P2ArrayPcut*)(part);
//}
//}}}
...
static int LenVarlen(Pcut *part, int ix, const char *whole) { return P2ArrayVarlenSize(whole); }
...
{ 
	P2ArrayPcut *derive = (P2ArrayPcut*)part;
