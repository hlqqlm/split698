...
static const P2CompactProxySetResponsePcut kP2CompactProxySetResponsePcutDefVar = kP2CompactProxySetResponsePcutDef;
static const PcutFactoryInfo kVarFactoryInfoList[kThisChoiceNum] = {
	...
	{ kP2CompactProxySetResponseName, sizeof(P2CompactProxySetResponsePcut), &kP2CompactProxySetResponsePcutDefVar, P2CompactProxySetResponsePcutOpenBase, P2CompactProxySetResponsePcutCloseBase },	// 代理精简设置服务器的若干个对象属性的响应 [3] CompactProxySetResponse，
