...
kFrame = (
    ...
    ("操作请求 [7] ACTION-Request / 请求操作一个对象方法 [1] ActionRequestNormal", "684B004303424129271065A1070103F2097F00020355070501002560932212005A0926682400430522936025000110B74205020004F100070040020200F1000200F10004000021C21600D44A16"),
    ("操作请求 [7] ACTION-Request / 请求操作若干个对象方法 [2] ActionRequestNormalList", ""),
    ("操作请求 [7] ACTION-Request / 请求操作若干个对象方法后读取若干个对象属性 [3] ActionThenGetRequestNormalList", ""),
